...
private:
    ...
    double takeoff_wait_s = 3.0;
    double forward_speed_mps = 5.0;
    double forward_duration_s = 20.0;
    double publish_rate_hz = 20.0;
    bool log_telemetry = false;
    std::string velocity_topic = "/airsim_node/drone_1/vel_body_cmd";
    int velocity_acceleration = 8;
